...
<body class="bg-gray-50 font-sans">
        ...
        <div class="p-4 rounded-lg mt-14">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <div class="flex items-center">
                        <div class="p-2 bg-yellow-100 rounded-lg">
                            <i class="fas fa-calendar-times text-warning text-xl"></i>
                        </div>
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Pending Leaves</p>
                            <p class="text-2xl font-bold text-gray-900" id="pendingLeaves">0</p>
                        </div>
                    </div>
                    <div class="mt-2 flex items-center text-sm">
                        <span class="text-red-600 font-medium" id="leavesChange">0</span>
                        <span class="text-gray-600 ml-1">new requests</span>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <a href="leaves.php" class="p-4 text-center hover:bg-gray-50 rounded-lg transition-colors block">
                        <div class="p-3 bg-yellow-100 rounded-lg inline-block mb-2">
                            <i class="fas fa-calendar-check text-warning text-xl"></i>
                        </div>
                        <p class="text-sm font-medium text-gray-900">Review Leaves</p>
                    </a>
    ...
    <script>
        ...
        class ClientDashboardManager {
            constructor() {
                this.apiBase = '/HCM/api/dashboard.php';
                this.profileApiBase = '/HCM/api/profile.php';
            ...
            async loadUserInfo() {
                try {
                    ...
                    // If there's a network error, also redirect to login
                    window.location.href = 'login.php';
                }
            }
            ...
            renderStats() {
                ...
                // Pending Leaves
                document.getElementById('pendingLeaves').innerHTML = data.pendingLeaves.toLocaleString();
                document.getElementById('leavesChange').innerHTML = `+${data.recentLeaves}`;
            ...
            renderStatsError() {
                ...
                document.getElementById('pendingLeaves').innerHTML = errorText;
